...
import { Send, Trash2, Wifi, WifiOff, Bot, Paperclip, Mic, Smile } from 'lucide-react';
    ...
    <div className="flex flex-col h-full bg-gray-100" style={{
      ...
      {messages.length === 0 && (
        <div className="p-4 text-center">
          <div className="bg-yellow-100 border border-yellow-200 rounded-lg p-4 mx-auto max-w-sm">
            ...
            <h3 className="text-base font-semibold text-gray-800 mb-2">¡Hola! Soy InfoBot</h3>            <p className="text-xs text-gray-600 mb-3">
              Tu asistente virtual de GRUPO INFOTEC. Puedo ayudarte con información sobre productos, 
              servicios técnicos, precios y más. 
              <br />
              <span className="text-gray-500 text-xs">Sesión: {sessionId.slice(-8)}</span>
            </p>
      ...
      <div className="flex-1 overflow-hidden">
        <div className="h-full px-4 py-2">
          <div className="h-full overflow-y-auto scroll-smooth">            <div className="space-y-1">
      ...
      </div>      {/* Área de input - WhatsApp Style Mejorada */}
      <div className="bg-gray-200 border-t border-gray-300 p-3">
        {/* Sugerencias rápidas */}
        {showSuggestions && !isLoading && (
          <div className="mb-3 flex flex-wrap gap-2">
            <span className="text-xs text-gray-600 mb-1 w-full">Sugerencias:</span>
        ...
        <form onSubmit={handleSubmit} className="flex items-center space-x-2">
          ...
          <button
            type="button"
            className="w-10 h-10 text-gray-500 hover:text-gray-700 rounded-full hover:bg-gray-300 transition-colors flex items-center justify-center"
          ...
          <div className="flex-1 relative">
            ...
            <div className="absolute right-4 top-1/2 transform -translate-y-1/2 flex items-center space-x-2">
              ...
              <div className={`text-xs ${inputValue.length > 800 ? 'text-red-500' : 'text-gray-400'}`}>
